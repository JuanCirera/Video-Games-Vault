                ...
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0 bg-gray-800">
                        <div class="card-header text-center pt-4 bg-gray-800">
                            <h5 class="text-white">Registrarse con</h5>
                        </div>
                        <div class="row px-xl-5 px-sm-4 px-3">
                            ...
                            {{-- TODO: Meter aqui steam y twitter para socialite --}}

                            <div class="mt-2 position-relative text-center">
                                <p
                                    class="text-sm font-weight-bold mb-2 text-secondary text-border d-inline z-index-2 text-white px-3">
                                    o bien
                                </p>
                            </div>
                        </div>
