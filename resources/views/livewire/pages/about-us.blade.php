<div>
    <div class="container mt-8 text-white w-md-90 w-lg-70">
        ...
        <p>
            ...
            sea que estés buscando un juego de aventuras, un shooter en primera persona o un juego de rol épico, nuestra
            plataforma tiene algo para todos.
        </p>
        <p>
            Con nuestra plataforma, puedes conectarte con otros jugadores y construir una comunidad en línea de personas
            apasionadas por los videojuegos. Comparte tus experiencias, descubre nuevos juegos y encuentra amigos con
            intereses similares.
        </p>
        <p>
            Estamos comprometidos con ofrecerte la mejor experiencia de usuario posible y nos esforzamos por mantener
            nuestra plataforma actualizada con las últimas características y tecnologías. Si tienes alguna pregunta,
