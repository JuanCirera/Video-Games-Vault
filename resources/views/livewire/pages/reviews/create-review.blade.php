<div>
    @guest
        <a href="{{ route('login') }}" class="btn btn-primary bg-gradient-primary btn-round my-0 text-nowrap">
                                ...
                                <form role="form">
                                    ...
                                    <div class="form-group mb-3 text-start">
                                        ...
                                        <textarea type="text" class="form-control bg-gray-700 text-white" placeholder="Escribe aquí tu reseña..."
                                            rows="7" aria-label="body" aria-describedby="body" wire:model="body"></textarea>
                                        @error('body')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div id="rating" class="form-group text-start">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input bg-gray-700" type="radio" name="rating"
                                                    id="positive" value="1" wire:model="rating">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input bg-gray-700" type="radio" name="rating"
                                                    id="negative" value="0" wire:model="rating">
